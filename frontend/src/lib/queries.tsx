...
export const useCreateTransaction = () => {
  ...
  return useMutation({
    mutationFn: ({ data }: { data: Partial<Transaction> }) => transactionApi.create(data),
...
export const useDeleteTransaction = () => {
  ...
  return useMutation({
    mutationFn: ({ id }: { id: string }) => transactionApi.delete(id),
...
export const useCreateCategory = () => {
  ...
  return useMutation({
    mutationFn: ({ data }: { data: Partial<Category> }) => categoryApi.create(data),
